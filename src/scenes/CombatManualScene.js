...
function buildPages(binds) {
  ...
  return [
    ...
    },
    {
      ...
      sections: [
        {
          heading: `PRIMARY  [${kPri}]  HOLD`,
          lines: [
            'Hold to auto-fire at the weapon\'s cadence.',
            'Fires toward your current / last move direction.',
            'Upgrade via level-up cards (Damage / Reach / Speed / Effect).',
          ],
        },
        {
          heading: `SECONDARY  [${kSec}]`,
          lines: [
            'Single tap — ~3 s cooldown.',
            'Upgrade via level-up cards same as the primary.',
            'After a Perfect Dodge the cooldown resets: punish immediately.',
          ],
        },
        {
